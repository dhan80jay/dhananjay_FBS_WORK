...
class TestBank {
	...
	public static void main(String[] args) {
	    ...
	    b1 = new BankAccount ("Ajay",143,20000,8976558,3475637,9876543);
		b1.display();
		...
		b1 = new SavingAccount ("Pratik",235,40000,4567854,456786,345567,60000,9,20000);
		b1.display();
		...
		b1 = new LoanAccount ("Amar",101,30000,34567,76543,234567,80000,10,30000);
		b1.display();
		System.out.println();
