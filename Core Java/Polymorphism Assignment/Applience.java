...
class TestApplience {
	public static void main (String [] args) {
		...
		a1 = new Applience ("Sony","Bravia X90L",250,3,12222,"2024-11-25");
		a1.display();
		
		System.out.println();
		
		a1 = new WashingMachine ();
		a1.display();
		
		System.out.println();
		
		a1 = new WashingMachine ("Sony","Bravia X90L",250,3,12222,"2024-11-25",10,"Eco wash",1400);
		a1.display();
		...
		a1 = new Microwave("Sony","Bravia X90L",250,3,12222,"2024-11-25",250,60,true);
		a1.display();
