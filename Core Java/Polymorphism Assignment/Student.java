...
class TestStudent {
    ...
    public static void main(String[] args) {
        ...
        s1 = new SchoolStudent (5,"Ajay",20,"b",12,"Math","A");
        s1.display();
        ...
        s1 = new ResearchScholar (6,"Dhananjay",24,"a","abc","xyz",91);
        s1.display();
        ...
        s1 = new CollegeStudent (8,"Pranav",20,"A","BCA",5,9);
        s1.display();
