...
class TestBank {
	...
	public static void main(String[] args) {
		...
		BankAccount b2 = new BankAccount ("Ajay",143,20000,8976558,3475637,9876543);
		b2.display();
		...
		SavingAccount s2 = new SavingAccount ("Pratik",235,40000,4567854,456786,345567,60000,9,20000);
		s2.display();
		...
		LoanAccount l2 = new LoanAccount ("Amar",101,30000,34567,76543,234567,80000,10,30000);
		l2.display();
		System.out.println();
		...
		CurrentAccount c2 = new CurrentAccount ("Ketan",111,23456,67890,56789,90000,20000,"Dairy",89588);
		c2.display();
