...
class TestOrder {
	public static void main (String [] args) {
		...
		Order o2 = new Order (102, "2025-09-20", 2500.00, "Amit Sharma", "45 Park Street, Mumbai", "Shipped");
		o2.display();
		
		System.out.println();
		
		OnlineOrder onr1 = new OnlineOrder();
		onr1.display();
		
		System.out.println();
		
		OnlineOrder onr2 = new OnlineOrder(103, "2025-09-19", 3200.75, "Neha Patel", "78 Main Road, Delhi", "Delivered","Debit Card", "TRK1002", "2025-09-24");
		onr2.display();
		...
		PreOrder p2 = new PreOrder (104, "2025-09-18", 1800.00, "Rahul Verma", "12 Green Lane, Bangalore", "Pending","2025-09-18", "Laptop Pro", 1000.00);
		p2.display();
		...
		StoreOrder s2 = new StoreOrder (105, "2025-09-17", 4000.20, "Pooja Singh", "56 Hill Street, Jaipur", "Cancelled","Mumbai West", "11:00 AM", "Anjali Verma");
		s2.display();
	}
}
