...
class TestStudent {
    ...
    public static void main(String[] args) {
        ...
        Student s2 = new Student (3,"Pratik",20,"c");
        s2.display();
        System.out.println();
        ...
        SchoolStudent ss2 = new SchoolStudent (5,"Ajay",20,"b",12,"Math","A");
        ss2.display();
        ...
        ResearchScholar r2 = new ResearchScholar (6,"Dhananjay",24,"a","abc","xyz",91);
        r2.display();
        ...
        CollegeStudent c2 = new CollegeStudent (8,"Pranav",20,"A","BCA",5,9);
        c2.display();
