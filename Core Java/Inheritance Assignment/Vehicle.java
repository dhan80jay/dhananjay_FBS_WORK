...
class TestVehicle {
	...
	public static void main(String[] args) {
	    ...
	    Vehicle v2 = new Vehicle ("MH14XY5678","Hyundai","Creta","Black","Diesel",1493);
		v2.display();
		...
		Car c2 = new Car ("MH31GH2468","Maruti","Swift","Red","Petrol",1197,5,286.0,"Manual");
		c2.display();
		...
		Bike b2 = new Bike ("MH31BK2468","Bajaj","Pulsar 150","Black","Petrol",150,70,true,5);
		b2.display();
	}
